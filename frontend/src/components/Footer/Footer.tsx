...
const Footer = () => {
  return (
    <footer className="flex flex-col !p-6 bg-[#fafafa]">
        ...
        <div className="flex items-center">
          ...
          <span className="font-normal text-base leading-snug tracking-tight text-center text-[#bebebe]">
            <div className="flex items-center space-x-1 gap-2">
              ...
              >
                <img src={GitHubImg} alt="GitHub Дмитро" className="h-7 w-auto" />
              </a>
      ...
      <div className="flex flex-col">
        <div className="flex justify-between">
          ...
          <div className="flex flex-col gap-2">
            <img src="/img/bank-logo-1.png" alt="Банк 1" className="w-auto h-auto"/>
            <img src="/img/bank-logo-2.png" alt="Банк 2" className="w-auto h-auto"/>
          </div>
        </div>
        <div className="border border-[#e7e6e6] w-full h-0 !mt-6 !mb-6"></div>
        <div>
